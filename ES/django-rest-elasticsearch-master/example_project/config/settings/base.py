...
ROOT_DIR = environ.Path(__file__) - 3  # (example_project/config/settings/base.py - 3 = example_project/)
...
LOCAL_APPS = [
    ...
    'example_project.blog.apps.BlogConfig',
]
...
ADMINS = [
    ("""Yaroslav Muravskyi""", 'y@myarik.com'),
]
